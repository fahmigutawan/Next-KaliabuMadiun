    ...
    const navbarItems: NavbarItem[] = [
        {
            ...
            submenu: [
                {
                    word: 'Tentang',
                    route: "/a/profile/about",
                },
                {
                    word: 'Sejarah',
                    route: "/a/profile/history",
                },
                {
                    word: 'Geografis & Demografis',
                    route: "/a/profile/geografis-demografi",
                },
            ]
        },
        {
        ...
        },
        {
            ...
            submenu: [
                {
                    word: 'Berita',
                    route: "/a/information/news",
                },
                {
                    word: 'Galeri',
                    route: "/a/information/gallery",
                }
            ]
        },
    ]
